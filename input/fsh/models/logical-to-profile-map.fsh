...
* beskrivning -> ""
* avser -> "Contract.topicReference(NDIUppdragLogical)"
* relationAvtal -> ""
...
* avser 0..* Reference(NDIUppdragLogical) "avser"
* avser ^definition = "avser"
* relationAvtal 0..* Reference(NDIAvtalLogical) ""
...
* giltigFrom 1..1 time "giltigFrom" // Tidpunkt
* giltigTom 0..1 time "giltigTom" // Tidpunkt
* har 0..1 Reference(NDIOrganisatoriskEnhetLogical) "har"
* har ^definition = "har"
* finnsTillgangligUnder 0..* Reference(NDITillganglighetstidLogical) "finns tillgänglig under"
* finnsTillgangligUnder ^definition = "finnsTillgangligUnder"
* arEnDelAv 0..* Reference(NDITelekommunikationLogical) "är en del av"
* arEnDelAv ^definition = "arEnDelAv"
* harTillganglighetsavvikelse 0..* Reference(NDIStorningsinformationLogical) "har tillgänglighetsavvikelse"
...
* giltigFrom 1..1 time "giltigFrom" // Tidpunkt
* giltigTom 0..1 time "giltigTom" // Tidpunkt
* relationOrganisation 0..* Reference(NDIOrganisationLogical) ""
* relationOrganisation ^definition = "relationOrganisation"
* har 0..* Reference(NDIKontaktuppgiftLogical) "har"
* har ^definition = "har"
* har 0..* Reference(NDITillstandLogical) "har"
* har ^definition = "har"
...
* giltigFrom 1..1 time "giltigFrom" // Tidpunkt
* giltigTom 0..1 time "giltigTom" // Tidpunkt
* relationOrganisatoriskEnhet 0..* Reference(NDIOrganisatoriskEnhetLogical) ""
* relationOrganisatoriskEnhet ^definition = "relationOrganisatoriskEnhet"
* tillhor 0..1 Reference(NDIOrganisationLogical) "tillhör"
* tillhor ^definition = "tillhor"
* arBelagenPa 0..* Reference(NDIPlatsLogical) "är belägen på"
* arBelagenPa ^definition = "arBelagenPa"
* erbjuder 0..* Reference(NDITjanstLogical) "erbjuder"
* erbjuder ^definition = "erbjuder"
* harOppetUnder 0..* Reference(NDITillganglighetstidLogical) "har öppet under"
...
* antar 0..* Reference(NDIPersonrollLogical) "antar"
...
* giltigFrom 1..1 time "giltigFrom" // Tidpunkt
* giltigTom 0..1 time "giltigTom" // Tidpunkt
* relationOrganisation 0..1 Reference(NDIOrganisationLogical) ""
* relationOrganisation ^definition = "relationOrganisation"
* relationOrganisatoriskEnhet 0..1 Reference(NDIOrganisatoriskEnhetLogical) ""
* relationOrganisatoriskEnhet ^definition = "relationOrganisatoriskEnhet"
* harDeltagande 0..1 Reference(NDIAvtalLogical) "har deltagande"
* harDeltagande ^definition = "harDeltagande"
* har 0..1 Reference(NDIKontaktuppgiftLogical) "har"
* har ^definition = "har"
...
* giltigFrom 1..1 time "giltigFrom" // Tidpunkt
* giltigTom 0..1 time "giltigTom" // Tidpunkt
* delAv 0..1 Reference(NDIPlatsLogical) "del av"
* delAv ^definition = "delAv"
* harPosition 0..1 Reference(NDIPositionLogical) "har position"
* harPosition ^definition = "harPosition"
* avgransasGeografisktAv 3..* Reference(NDIPositionLogical) "avgränsas geografiskt av"
...
* finnsTillganglig 1..* Reference(NDITjanstLogical) "finns tillgänglig"
